	...
	public void sortArrayPackage(ArrayList<PackageInfo> array) {
		Collections.sort(array, new Comparator<PackageInfo>(){
			public int compare(PackageInfo o1, PackageInfo o2) {
				...
				String appName_package1 = (String) mActivity.getApplicationLabel(packageManager.getApplicationInfo(appName_package1, PackageManager.GET_META_DATA));
				String appName_package2 = (String) mActivity.getApplicationLabel(packageManager.getApplicationInfo(appName_package2, PackageManager.GET_META_DATA));
